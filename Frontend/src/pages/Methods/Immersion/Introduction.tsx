...
export default function Introduction() {
  return (
    <>
    <div className="flex flex-col max-w-300 mx-auto mt-30">
      <div className="flex flex-col self-start max-w-100">
      <h1 className="text-5xl pt-5">Introduction</h1>
      <h2 className="text-2xl">Welcome to the Japanese Language!</h2>
      </div>
